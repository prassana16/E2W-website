  ...
  return (
    <section className="min-h-screen flex flex-col items-center bg-gradient-to-br from-[#f2bdad] to-[#ff5f2e] py-16 px-4 md:px-16 font-mono">
      <div className="flex flex-col items-center md:flex-row md:items-start gap-12 max-w-screen-lg w-full">
        ...
        <div>
          {/* Header */}
          <h2 className="text-4xl font-semibold text-[#333] mb-4">UI/UX Design</h2>
          ...
          <div className="mt-8">
            <img
              src="path/to/ui-ux-design-image.jpg" // Replace with actual path
          ...
          <div className="mt-16">
            <h3 className="text-3xl font-semibold text-[#333]">Current Trends in UI/UX Design</h3>
          ...
          {/* Future UI/UX Trends */}
          <div className="mt-16">
            <h3 className="text-3xl font-semibold text-[#333]">Future Trends in UI/UX Design</h3>
            <p className="text-lg text-[#fff] mt-4 leading-relaxed">
