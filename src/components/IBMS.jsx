...
export default function IBMS() {
  ...
  const ibmsSchema = {
    ...
    "operatingSystem": "Web",
    "description": "Intelligent Business Management Software (IBMS) for optimizing sales processes and converting prospects. Perfect for businesses in USA, Canada, UK, India, and specifically Tamil Nadu region.",
    "offers": {
      "@type": "Offer",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#2D1B69] to-[#1A103F] text-white">
      <SEO 
        title="IBMS - Intelligent Business Management System | Easy2Work"
        description="Transform your business operations with Easy2Work's Intelligent Business Management System (IBMS). Streamline processes, improve efficiency, and drive growth with our comprehensive business management solution."
        keywords="IBMS, Intelligent Business Management System, business automation, process optimization, enterprise software, workflow management, business analytics, resource planning, project management, task automation"
        schema={ibmsSchema}
        region="global"
      />
      <HeroSection />
...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 md:px-8 lg:px-16 overflow-hidden">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-black bg-opacity-50 z-10"></div>      {/* Content */}
      <motion.div 
      ...
      >
        <motion.div
          ...
          className="mb-6"
        >
          <span className="inline-block px-6 py-2 bg-purple-900/80 text-purple-100 text-sm rounded-full mb-4 backdrop-blur-sm border border-purple-500/30">
            Enterprise Business Solution
          </span>
        </motion.div>
        
        <motion.h1 
          className="text-4xl md:text-7xl font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-200 to-purple-400"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p 
          className="text-lg md:text-xl mb-8 text-purple-100 max-w-3xl mx-auto leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.6, duration: 0.8 }}
        >
          Transform your business operations with our comprehensive enterprise solution. IBMS streamlines processes, automates workflows, and provides actionable insights for informed decision-making.
        </motion.p>
        ...
        >
          <a href="#modules">
            <button className="bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 text-white px-8 py-3 rounded-lg font-medium transition duration-300 w-full sm:w-auto shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40">
              Explore IBMS
            </button>
          </a>
          <a href="#demo">
            <button className="bg-purple-900/30 border border-purple-500/30 hover:bg-purple-800/40 text-white px-8 py-3 rounded-lg font-medium transition duration-300 w-full sm:w-auto backdrop-blur-sm">
              Request Demo
            </button>
          </a>
        </motion.div>
...
const TabsSection = ({ activeTab, setActiveTab }) => {
  return (    <div className="bg-[#1A103F] sticky top-0 z-30 shadow-xl border-b border-purple-500/20">
...
const FeaturesSection = () => {  const features = [
    {
      ...
      description: "Get real-time insights into your business performance with comprehensive analytics, KPIs, and customizable reports for data-driven decision making."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const FeatureCard = ({ feature, index }) => {
  ...
  return (
    <motion.div
      ...
      animate={controls}
      variants={variants}
      className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 p-8 rounded-xl shadow-lg border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 hover:shadow-purple-500/20 h-full backdrop-blur-sm"
    >      <div className="text-purple-400 mb-4 transform transition-transform duration-300 group-hover:scale-110">{feature.icon}</div>
      <h3 className="text-xl text-purple-100 font-bold mb-3">{feature.title}</h3>
