    ...
    <section className="py-20 md:py-28" id="intro" style={{ 
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            <span className="relative">
              ...
              <span className="absolute bottom-1 left-0 w-full h-3 bg-cyan"></span>
            </span>
          </motion.h2>
          <motion.p 
            initial={{ scale: 0, y: 20 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          ...
          <motion.div
            className="flex flex-col p-8 rounded-xl bg-white border border-cyan hover:border-cyan transition-all duration-300"
        ...
        >
          <a href="/ContactForm" className="inline-block px-8 py-4 bg-cyan text-black text-lg font-bold rounded-lg hover:bg-black hover:text-cyan transition-all duration-300 border border-cyan transform hover:-translate-y-1">
