    ...
    >
      ...
      >
        <motion.div
          ...
          animate="visible"
          exit="exit"
          className={`absolute inset-0 flex flex-col md:flex-row items-center w-full h-screen bg-gradient-to-r ${slides[currentIndex].bgColor}`}
        >
          {/* Content section */}
