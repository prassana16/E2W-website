...
function AboutPWA() {
  return (    <section
      ...
      style={{ background: 'radial-gradient(ellipse at center, #000000, #05f4f9)' }}
    >
      ...
      <div className="w-full flex">
        {[...Array(26)].map((_, i) => (
          <motion.div
            ...
            style={{ background: 'linear-gradient(to bottom, #05f4f9, #05f4f9)' }}
            initial={{ scaleY: 1 }}
      ...
      <h2 className="text-2xl md:text-5xl text-white text-center font-Tinos mb-8 md:mb-16 mt-16">
...
<div className="flex flex-col items-center justify-center gap-4 md:gap-6 p-4 md:p-6 w-full ">
  ...
  <div className="flex flex-col md:flex-row ">
    {/* Left Column */}
    <motion.div
      className="flex flex-col items-center justify-center p-4 md:p-6 bg-black rounded-2xl border border-cyan shadow-md w-full max-w-xl md:max-w-7xl  "
    ...
    >
      <div className="text-4xl md:text-6xl mb-4">
        ...
        <h3 className="text-xl md:text-3xl font-semibold text-white mb-4 md:mb-6 text-left md:text-center">
          What is a Progressive Web Application (PWA)?
        </h3>
        <p className="text-sm md:text-lg text-white mb-4 text-left">
        ...
        </p>        <p className="text-sm md:text-lg text-white mb-4 text-left">
        ...
        {/* Expertise Card */}  <motion.div
    className="w-full flex flex-col items-center justify-center p-4 md:p-8 bg-black rounded-2xl border border-cyan shadow-lg mb-8 md:mb-12 max-w-xl md:max-w-7xl mx-4 text-left"
    initial={{ opacity: 0, y: 60 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.5 }}
  >
    <h3 className="text-2xl md:text-4xl font-semibold text-white mb-4 md:mb-6 text-left">
    ...
    <p className="text-sm md:text-lg text-white">
      ...
      <div className="w-full flex mt-16 md:mt-24">
        {[...Array(26)].map((_, i) => (
          <motion.div
            key={i}
            className="bg-cyan h-[2px] w-full"
            initial={{ scaleY: 1 }}
